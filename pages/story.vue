    ...
    <main class="story-main">
      <div class="main-banner common-banner">
        <div class="banner-title-box">
          <h2 class="tit-cn">品牌故事</h2>
          <h2 class="tit-en">Our story</h2>
        </div>
      </div>
      <div class="page-wrapper">
        ...
        <section class="sec03">
          <div class="sec03-item">
            <img class="item-img" src="@/assets/images/wap/about/img47.jpg" alt="" />
          ...
          <div class="sec03-item">
            <img class="item-img" src="@/assets/images/wap/about/img48.jpg" alt="" />
          ...
          <div class="sec03-item">
            <img class="item-img" src="@/assets/images/wap/about/img482.jpg" alt="" />
